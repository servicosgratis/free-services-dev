...
## IDE and Code Editing
  ...
  * [Binder](https://mybinder.org/) — Turn a Git repo into a collection of interactive notebooks. Free public service.
  ...
  * [Sublime Text](https://www.sublimetext.com/) — Popular, versatile, and highly customizable text editor.
...
## Testing
  ...
  * [Repeato](https://repeato.app/) — No-code mobile app test automation for native, flutter, react-native, and more. Free plan includes 10 tests for iOS and 10 for Android.
...
## BaaS (Backend as a Service)
  ...
  * [Progress Kinvey](https://www.progress.com/kinvey) — Mobile backend, starter plan has unlimited requests/second, with 1 GB of data storage. Enterprise application support.
...
## CDN and Protection
  ...
  * [Statically](https://statically.io/) — CDN for Git repos, WordPress assets, and images.
...
## Managed Data Services
  ...
  * [Scalingo](https://scalingo.com/) — Primarily a PaaS but offers a 128MB to 192MB free tier of MySQL, PostgreSQL, or MongoDB.
...
## Tools for Teams and Collaboration
  ...
  * [Tugboat](https://tugboat.qa) — Preview pull requests with automated and on-demand environments. Free for non-profits.
...
## APIs, Data, and ML
  ...
  * [Colaboratory](https://colab.research.google.com) — Free Python notebook environment with Nvidia Tesla K80 GPU.
  ...
  * [Geekflare API](https://geekflare.com/api) — API suite for screenshots, website audits, DNS lookups, and more. Free plan includes 3,000 requests.
  ...
  * [MockAPI](https://www.mockapi.io/) — Quickly mock APIs and generate custom data. Free for one project and 4 resources per project.
  ...
  * [Roboflow](https://roboflow.com) — Create and deploy custom computer vision models. Free tier includes up to 1,000 source images.
  ...
  * [vatcheckapi.com](https://vatcheckapi.com) — Simple and free VAT number validation API with 500 free requests per month.
  ...
  * [ERD Lab](https://www.erdlab.io) — Free cloud-based ERD tool for database design.
  * [What The Diff](https://whatthediff.ai) — AI-powered code review assistant. Free tier allows for up to 25,000 tokens (~10 PRs) monthly.
  * [Zipcodestack](https://zipcodestack.com) — Free zip code and postal code validation API. Free tier includes 10,000 requests per month.
  * [Zuplo](https://zuplo.com/) — Free API management platform. Add authentication, rate limiting, and API documentation with ease.
  * [OpenWeb Ninja](https://www.openwebninja.com/) — Comprehensive real-time SERP and public data APIs. Free tier includes up to 200 monthly requests.
  * [Tavily AI](https://tavily.com/) — AI-powered research and organization API. Free tier includes 1,000 requests per month.

## Payment and Billing Integration
  * [Qonversion](http://qonversion.io/) — All-in-one subscription management platform with analytics, A/B testing, Apple Search Ads, and monetization tools. Free up to $10k in monthly tracked revenue.
  * [ParityVend](https://www.ambeteco.com/ParityVend/) — Automatically adjust pricing based on visitor location to expand globally. Free plan includes 7,500 API requests/month.
  * [Glassfy](https://glassfy.io/) — In-app subscriptions infrastructure with real-time events and monetization tools. Free up to $10k monthly revenue.
  * [Adapty](https://adapty.io/) — Solution for in-app subscription integration for iOS, Android, and web apps. Free up to $10k monthly revenue.
  * [CoinMarketCap](https://coinmarketcap.com/api/) — Cryptocurrency market data including exchange rates. Free tier offers 10K call credits/month.
  * [CurrencyFreaks](https://currencyfreaks.com/) — Current and historical currency exchange rates. Free developer plan with 1,000 requests/month.
  * [CoinGecko](https://www.coingecko.com/en/api) — Cryptocurrency market data with exchange rates and historical data. Free demo API with 10,000 calls/month.
  * [CurrencyApi](https://currencyapi.net/) — Live currency rates for physical and cryptocurrencies. Free tier offers 1,250 API requests/month.
  * [CurrencyLayer](https://currencylayer.com/) — Reliable exchange rates and currency conversion. Free plan offers 100 API requests/month.
  * [ExchangeRate-API](https://www.exchangerate-api.com) — Easy-to-use currency conversion JSON API. Free tier updates daily, limit of 1,500 requests/month.
  * [FraudLabsPRO](https://www.fraudlabspro.com) — Helps merchants prevent payment fraud and chargebacks. Free Micro Plan with 500 queries/month.
  * [FxRatesAPI](https://fxratesapi.com) — Real-time and historical exchange rates. Free tier requires attribution.
  * [MailPopin](https://mailpop.in) — Enhance Stripe notifications with contextualized information.
  * [Moesif API Monetization](https://www.moesif.com/) — Generate revenue from APIs via usage-based billing. Free tier offers 30,000 events/month.
  * [Nami ML](https://www.namiml.com/) — Platform for in-app purchases and subscriptions with no-code paywalls. Free for base features.
  * [RevenueCat](https://www.revenuecat.com/) — Backend for in-app purchases and subscriptions for iOS and Android. Free up to $2.5k/mo tracked revenue.
  * [Vatlayer](https://vatlayer.com/) — Instant VAT validation and EU VAT rates API. Free for 100 API requests/month.
  * [Currencyapi](https://currencyapi.com) — Currency conversion and exchange rate data API. Free for 300 requests/month, 10 requests/minute.
...
## Screenshot APIs
  ...
  * [Microlink](https://microlink.io/) — Turns any website into data, including metatags normalization, link previews, scraping capabilities, and screenshots as a service. Free for 250 requests/day.
  * [ScreenshotAPI.net](https://screenshotapi.net/) — Generate screenshots of any website with a simple API call. Hosted on Google Cloud. Offers 100 free screenshots/month.
  * [ScreenshotLayer](https://screenshotlayer.com/) — Capture highly customizable snapshots of any website. Free tier includes 100 snapshots/month.
  * [ScreenshotMachine](https://www.screenshotmachine.com/) — Capture 100 snapshots/month in PNG, GIF, or JPG formats, including full-length captures.
  * [PhantomJsCloud](https://PhantomJsCloud.com) — Browser automation and page rendering. Free tier offers up to 500 pages/day since 2017.
  * [WebShrinker](https://webshrinker.com/) — Provides website screenshots and domain intelligence API services. Free for 100 requests/month.
  * [Httpic](https://httpic.com/) — Turn any website into JPG, PNG, or PDF. Capture full-page screenshots, adjust viewport, and inject custom code. Free for 150 images/month.
  * [Screenshots](https://screenshotson.click) — Your API for Screenshots with highly customizable options. Free for 100 screenshots/month.

## Tunneling, WebRTC, Web Socket Servers and Other Routers
  * [Pinggy](https://pinggy.io) — Public URLs for localhost with a single command, no downloads required. HTTPS / TCP / TLS tunnels. Free plan includes 60 minutes tunnel lifetime.
  * [Conveyor](https://conveyor.cloud/) — Visual Studio extension to expose IIS Express to the local network or over a tunnel to a public URL.
  * [Hamachi](https://www.vpn.net/) — Hosted VPN service for LAN-like networks. Free for unlimited networks with up to 5 people.
  * [Mirna Sockets](https://mirna.cloud/) — Free Socket as a Service platform that provides a WebSocket URL and allows monitoring of performance.
  * [localhost.run](https://localhost.run/) — Expose locally running servers over a tunnel to a public URL.
  * [localtunnel](https://theboroer.github.io/localtunnel-www/) — Expose locally running servers over a tunnel to a public URL. Free hosted version and open source.
  * [ngrok](https://ngrok.com/) — Expose locally running servers over a tunnel to a public URL.
  * [Cname.dev](https://cname.dev/) — Free and secure dynamic reverse proxy service.
  * [Serveo](https://serveo.net/) — Expose local servers to the internet. No installation or signup required. Free subdomain, no limits.
  * [Radmin VPN](https://www.radmin-vpn.com/) — Connect multiple computers via a VPN-enabling LAN-like network. Unlimited peers. (Hamachi alternative)
  * [Segment](https://segment.com/) — Hub to translate and route events to third-party services. Free for 100,000 events/month.
  * [Google STUN](stun:stun.l.google.com:19302) — Google's public STUN server.
  * [Twilio STUN](stun:global.stun.twilio.com:3478?transport=udp) — Twilio's public STUN server.
  * [Tailscale](https://tailscale.com/) — Zero config VPN using the open-source WireGuard protocol. Free plan for personal use with up to 100 devices and 3 users.
  * [Webhook Relay](https://webhookrelay.com) — Manage, debug, fan-out, and proxy webhooks to public or internal destinations. Also exposes private servers over a tunnel.
  * [Hookdeck](https://hookdeck.com/pricing) — Develop, test, and monitor webhooks. Free for 100K requests and attempts per month with three days of retention.
  ...
  * [ZeroTier](https://www.zerotier.com/) — FOSS managed virtual Ethernet as a service. Free for up to 25 clients.
  * [LocalXpose](https://localxpose.io/) — Reverse proxy to expose localhost servers to the internet. Free plan includes 15 minutes tunnel lifetime.
  * [Traefik-Hub](https://traefik.io/traefik-hub/) — Publish local services to a public URL with access control. Free for 5 services in one cluster.
  ...
  * [Btunnel](https://www.btunnel.in/) — Expose localhost and local TCP server to the internet. Free plan includes 1-hour tunnel timeout and basic auth.
...
## CI and CD
  ...
  * [Argonaut](https://argonaut.dev/) — Deploy apps and infrastructure on your cloud in minutes. Support for custom and third-party app deployments on Kubernetes and Lambda environments.
  * [bitrise.io](https://www.bitrise.io/) — A CI/CD for mobile apps, native or hybrid. With 200 free builds/month, 10 min build time, and two team members.
  * [buddy.works](https://buddy.works/) — A CI/CD with five free projects and one concurrent run (120 executions/month).
  * [Buildkite](https://buildkite.com) — CI Pipelines free for 3 users and 5k job minutes/month.
  * [bytebase.com](https://www.bytebase.com/) — Database CI/CD and DevOps. Free under 20 users and ten database instances.
  * [CircleCI](https://circleci.com/) — Comprehensive free plan with all features included for GitHub, GitLab, and BitBucket repositories.
  ...
  * [drone](https://cloud.drone.io/) — Drone Cloud enables developers to run Continuous Delivery pipelines across multiple architectures.
  ...
  * [Mergify](https://mergify.io) — Workflow automation and merge queue for GitHub.
  * [Make](https://www.make.com/en) — Workflow automation tool for connecting apps. Free for public GitHub repositories.
  * [Spacelift](https://spacelift.io/) — Management platform for Infrastructure as Code. Free plan includes IaC collaboration.
  * [microtica.com](https://microtica.com/) — Startup environments with ready-made infrastructure components. Free tier includes one environment.
  * [Nx Cloud](https://nx.dev/ci) — Nx Cloud speeds up monorepos on CI with remote caching and task distribution.
  * [blacksmith](https://www.blacksmith.sh/) — Managed performance runners for GitHub Actions. 3,000 free minutes per month.
  * [Terramate](https://terramate.io/) — Orchestration and management platform for Infrastructure as Code. Free for up to 2 users.

## Monitoring
  * [Pingmeter](https://pingmeter.com/) — 5 uptime monitors with 10-minute interval. Monitor SSH, HTTP, HTTPS, and any custom TCP ports.
  * [Alerty.ai](https://www.alerty.ai) — Free APM and monitoring for your FE, BE, DB, and more + free agent runs.
  * [AppDynamics](https://www.appdynamics.com/) — Free for 24-hour metrics, application performance management agents limited to one Java, one .NET, one PHP, and one Node.js.
  * [AppNeta](https://www.appneta.com/) — Free with 1-hour data retention.
  * [AppSpector](https://appspector.com/) — Mission control for remote iOS/Android/Flutter debugging. Free for small traffic usage (64MB of logs).
  * [Assertible](https://assertible.com) — Automated API testing and monitoring. Free plans for teams and individuals.
  * [Bleemeo](https://bleemeo.com) — Free for 3 servers, 5 uptime monitors, unlimited users, unlimited dashboards, unlimited alerting rules.
  * [ChecklyHQ](https://checklyhq.com) — Open source E2E / Synthetic monitoring and deep API monitoring for developers. Free plan with five users and 50k+ check runs.
  ...
  * [Cronitor](https://cronitor.io/) — Performance insights and uptime monitoring for cron jobs, websites, APIs and more. A free tier with five monitors.
  * [Datadog](https://www.datadoghq.com/) — Free for up to 5 nodes.
  * [Dead Man's Snitch](https://deadmanssnitch.com/) — Monitoring for cron jobs. One free snitch (monitor), more if you refer others to sign up.
  * [Downtime Monkey](https://downtimemonkey.com/) — 60 uptime monitors, 5-minute interval. Email, Slack alerts.
  * [Economize Cloud](https://economize.cloud) — Organizes cloud resources to optimize costs. Free for up to $5,000 spent on Google Cloud Platform every month.
  * [Elastic APM](https://www.elastic.co/solutions/apm) — Instant performance insights for JS developers. Free with 24-hour data retention.
  * [Grafana Cloud](https://grafana.com/products/cloud/) — Observability platform with metrics and logs. Free: 3 users, 10 dashboards, 100 alerts, metrics and logs storage.
  * [Healthchecks.io](https://healthchecks.io) — Monitor your cron jobs and background tasks. Free for up to 20 checks.
  * [Hydrozen](https://hydrozen.io) — Uptime monitoring & Status pages. Free: 10 uptime monitors, 5 heartbeat monitors, 1 domain monitor, and 1 status page.
  * [Inspector.dev](https://www.inspector.dev) — Real-Time monitoring dashboard. Free forever tier.
  * [Instrumental](https://instrumentalapp.com) — Application and server monitoring with up to 500 metrics and 3 hours of data visibility for free.
  * [Keychest Speed Test](https://keychest.net/speedtest) — Independent speed test and TLS handshake latency test against Digital Ocean.
  * [LetsMonitor](https://letsmonitor.org) — SSL monitoring, free for up to 5 monitors.
  * [LinkOK](https://linkok.com) — Online broken link checker, free for small websites up to 100 pages.
  * [Loader.io](https://loader.io/) — Free load testing tools with limitations.
  * [Netdata Cloud](https://www.netdata.cloud/) — Open-source tool to collect real-time metrics.
  * [New Relic](https://www.newrelic.com) — Observability platform for software monitoring. Free tier with 100GB/month of data ingest.
  * [Middleware.io](https://middleware.io/) — Observability platform with Log monitoring for up to 1M log events, Infrastructure monitoring & APM.
  * [Nixstats](https://nixstats.com) — Free for one server. E-Mail Notifications, public status page, 60-second interval, and more.
  * [OnlineOrNot](https://onlineornot.com/) — Uptime monitoring for websites and APIs, monitoring for cron jobs and scheduled tasks. First five checks are free.
  * [OntarioNet CN Test](https://cntest.ontarionet.ca) — Check if a website is blocked in China by the Great Firewall.
  * [OpsGenie](https://www.opsgenie.com/) — Alerting and on-call management for operating always-on services. Free up to 5 users.
  * [Paessler PRTG](https://www.paessler.com/) — Infrastructure and network monitoring solution with up to 100 sensors free.
  * [Pagecrawl.io](https://pagecrawl.io/) — Monitor website changes, free for up to 6 monitors with daily checks.
  * [Syagent](https://syagent.com/) — Noncommercial free server monitoring service, alerts and metrics.
  * [Pagerly](https://pagerly.io/) — Manage on-calls on Slack (integrates with Pagerduty, OpsGenie). Free for one team.
  * [Pagertree](https://pagertree.com/) — Interface for alerting and on-call management. Free up to 5 users.
  * [Pingbreak](https://pingbreak.com/) — Modern uptime monitoring service. Check unlimited URLs with notifications.
  * [Pingpong](https://pingpong.one/) — Advanced status page platform with monitoring. Free public customizable status page.
  * [Robusta](https://home.robusta.dev/) — Kubernetes monitoring based on Prometheus with integrations. Free up to 20 nodes.
  * [Sematext](https://sematext.com/) — Free for 24-hour metrics, unlimited servers, custom metrics, unlimited dashboards, and users.
  * [Sitemonki](https://sitemonki.com/) — Website, domain, Cron & SSL monitoring. 5 monitors in each category for free.
  * [SiteSure](https://sitesure.net) — Website and cron monitoring - 2 monitors free.
  ...
  * [StatHat](https://www.stathat.com/) — Get started with ten stats for free, no expiration.
  * [StatusCake](https://www.statuscake.com/) — Website monitoring, unlimited tests free with limitations.
  * [StatusGator](https://statusgator.com/) — Status page monitoring, 3 monitors free.
  ...
  * [UptimeToolbox](https://uptimetoolbox.com/) — Free monitoring for five websites, 60-second intervals, public status page.
  * [Zenduty](https://www.zenduty.com/) — End-to-end incident management and on-call platform for DevOps teams. Free up to 5 users.
  * [Instatus](https://instatus.com) — Get a beautiful status page in 10 seconds. Free forever with unlimited subs and unlimited teams.
  * [Squadcast](https://squadcast.com) — Incident management software with a free forever plan for up to 10 users.
  * [RoboMiri](https://robomiri.com/) — Uptime monitoring: 25 uptime checks with 3-minute interval checks for free. Alerts via Phone Call, SMS, Email, and Webhooks.
  * [Better Stack](https://betterstack.com/better-uptime) — Uptime monitoring, incident management, on-call scheduling/alerting, and status pages. Free plan includes 10 monitors with 3-minute check frequency and status pages.
  * [Pulsetic](https://pulsetic.com) — 10 monitors, 6 Months of historical Uptime/Logs, unlimited status pages, and custom domains included for free.
  * [Wachete](https://www.wachete.com) — Monitor five pages, checks every 24 hours.
  * [Xitoring](https://xitoring.com/) — Uptime monitoring: 20 free, Linux and Windows Server monitoring: 5 free, Status page: 1 free.

## Log Management
  * [Bugfender](https://bugfender.com/) — Free up to 100k log lines/day with 24 hours retention.
  * [Logentries](https://logentries.com/) — Free up to 5 GB/month with seven days retention.
  * [Loggly](https://www.loggly.com/) — Free for a single user, 200MB/day with seven days retention.
  ...
  * [Papertrail](https://papertrailapp.com/) — 48 hours search, seven days archive, 50 MB/month.
  * [Sematext](https://sematext.com/logsene) — Free up to 500 MB/day, seven days retention.
  * [Sumo Logic](https://www.sumologic.com/) — Free up to 500 MB/day, seven days retention.
  * [Logflare](https://logflare.app/) — Free for up to 12,960,000 entries per app per month, 3 days retention.
  * [Logtail](https://logtail.com/) — ClickHouse-based SQL-compatible log management. Free up to 1 GB per month, three days retention.
  * [Logzab](https://logzab.com/) — Audit trail management system. Free 1,000 user activity logs per month, 1-month retention, for up to 5 projects.

## Crash and Exception Handling
  * [CatchJS](https://catchjs.com/) — JavaScript error tracking with screenshots and click trails. Free for open-source projects.
  ...
  * [Honeybadger](https://www.honeybadger.io) — Exception, uptime, and cron monitoring. Free for small teams and open-source projects (12,000 errors/month).
  * [Memfault](https://memfault.com) — Cloud device observability and debugging platform. 100 devices free for Nordic, NXP, and Laird devices.
  ...
  * [Sentry](https://sentry.io/) — Sentry tracks app exceptions in real-time and has a small free plan. Free for 5k errors per month/ 1 user, unrestricted use if self-hosted.
  * [Axiom](https://axiom.co/) — Store up to 0.5 TB of logs with 30-day retention. Integrations with platforms like Vercel and advanced data querying with email/Discord notifiers.
...
## Visitor Session Recording
  * [Reactflow](https://www.reactflow.com/) — Per site: 1,000 page views/day, three heatmaps, three widgets, free bug tracking.
  * [OpenReplay](https://www.openreplay.com) — Open-source session replay with dev tools for bug reproduction, live session for support, and product analytics suite. Free for 1,000 sessions/month with 7-day retention.
  * [LogRocket](https://www.logrocket.com) — 1,000 sessions/month with 30-day retention, error tracking, live mode.
  * [FullStory](https://www.fullstory.com) — 1,000 sessions/month with one month of data retention and three user seats.
  * [Hotjar](https://www.hotjar.com/) — Per site: 1,050 page views/month, unlimited heatmaps, data stored for three months.
  * [Inspectlet](https://www.inspectlet.com/) — 2,500 sessions/month free for one website.
  ...
  * [Mouseflow](https://mouseflow.com/) — 500 sessions/month free for one website.
  * [Mousestats](https://www.mousestats.com/) — 100 sessions/month free for one website.
  * [Smartlook](https://www.smartlook.com/) — Free packages for web and mobile apps (1,500 sessions/month), three heatmaps, one funnel, 1-month data history.
  * [Usersurge](https://www.usersurge.com/) — 250K sessions per month for individuals.
  * [Howuku](https://howuku.com) — Track user interaction, engagement, and events. Free for up to 5,000 visits/month.
  * [UXtweak](https://www.uxtweak.com/) — Record and watch how visitors use your website or app. Free unlimited time for small projects.

## Analytics, Events and Statistics
  * [Dwh.dev](https://dwh.dev) — Data Cloud Observability Solution (Snowflake). Free for personal use.
  * [Hightouch](https://hightouch.com/) — Reverse ETL platform to sync customer data from data warehouses to CRM, marketing, and support tools. Free tier includes one destination to sync data.
  * [Avo](https://avo.app/) — Simplified analytics workflow with a single source of truth, type-safe libraries, and data observability. Free for two workspace members.
  * [Branch](https://branch.io) — Mobile Analytics Platform with deep-linking. Free tier supports up to 10K mobile app users.
  * [Cauldron](https://cauldron.io) — Open-source analytics solution aggregating data from multiple collaboration platforms. Free tier includes unlimited reports.
  * [Census](https://www.getcensus.com/) — Reverse ETL & Operational Analytics Platform. Free tier syncs 10 fields from data warehouses to 60+ SaaS tools.
  * [Clicky](https://clicky.com) — Website analytics platform. Free plan includes 3,000 views for one website.
  * [Databox](https://databox.com) — Business Insights & Analytics platform combining data from various sources. Free plan includes 3 users and dashboards.
  * [Hitsteps](https://hitsteps.com/) — Website analytics tool. Free for up to 2,000 pageviews per month for one website.
  * [Amplitude](https://amplitude.com/) — Analytics platform offering 1M monthly events for up to 2 apps in the free plan.
  * [GoatCounter](https://www.goatcounter.com/) — Open-source web analytics platform for non-commercial use. Free tier includes unlimited sites, 6 months of data retention, and 100K pageviews/month.
  * [Google Analytics](https://analytics.google.com/) — Comprehensive analytics platform by Google.
  * [MetricsWave](https://metricswave.com) — Privacy-friendly alternative to Google Analytics. Free plan supports 20K pageviews/month.
  * [Expensify](https://www.expensify.com/) — Expense reporting tool. Free personal reporting approval workflow.
  * [GetInsights](https://getinsights.io) — Privacy-focused, cookie-free analytics. Free for up to 3K events/month.
  * [Heap](https://heap.io) — Automatically captures user actions in iOS or web apps. Free for up to 10K monthly sessions.
  * [Hotjar](https://hotjar.com) — Website analytics and reports. Free plan supports 2K pageviews/day and 3 surveys/month.
  * [Keen](https://keen.io/) — Custom analytics for data collection, analysis, and visualization. Free for up to 1K events/month.
  * [Yandex.Datalens](https://datalens.yandex.com/) — Data visualization and analysis service by Yandex. Free with no restrictions on users or requests.
  * [Yandex.Metrica](https://metrica.yandex.com/) — Unlimited free analytics service by Yandex.
  * [Mixpanel](https://mixpanel.com/) — 100K monthly tracked users, unlimited data history, and seats. Free tier with US or EU data residency.
  * [Moesif](https://www.moesif.com/) — API analytics for REST and GraphQL. Free up to 500K API calls per month.
  * [Optimizely](https://www.optimizely.com/) — A/B Testing solution. Free starter plan for one website, 1 iOS, and 1 Android app.
  * [Microsoft Power BI](https://powerbi.com/) — Business Insights & Analytics by Microsoft. Free plan offers limited use with 1M user licenses.
  * [Quantcast](https://www.quantcast.com/products/measure-audience-insights/) — Unlimited free analytics for web and mobile apps.
  * [Row Zero](https://rowzero.io/) — Fast connected spreadsheet. Import, analyze, graph, and share millions of rows. Free for 3 workbooks.
  * [Sematext](https://sematext.com/cloud/) — Free for up to 50K actions/month, 1-day data retention, unlimited dashboards and users.
  * [SimilarWeb](https://similarweb.com/) — Analytics for web and mobile apps. Free plan offers limited data for websites and apps.
  * [StatCounter](https://statcounter.com/) — Website viewer analytics. Free plan tracks analytics for the 500 most recent visitors.
  * [Statsig](https://statsig.com/) — All-in-one platform for analytics, feature flagging, and A/B testing. Free for up to 1M events/month.
  * [Tableau Developer Program](https://www.tableau.com/developer/) — Personal development sandbox license for Tableau Online. Latest pre-release version for testing new features.
  * [UsabilityHub](https://usabilityhub.com/) — Test designs and mockups on real users. Free for one user with unlimited tests.
  * [Woopra](https://www.woopra.com/) — User analytics platform. Free for up to 500K actions, 90-day data retention, and 30+ integrations.
  * [Counter.dev](https://counter.dev/) — Simple, privacy-friendly web analytics. Free or donation-based pricing.
  * [PostHog](https://posthog.com/) — Full product analytics suite. Free for up to 1M tracked events per month.
  * [Uptrace](https://uptrace.dev/) — Distributed tracing tool for pinpointing failures and performance bottlenecks. Free plan available.
  * [Microsoft Clarity](https://clarity.microsoft.com/) — Free tool for capturing how real people use your site.
  * [Beampipe](https://beampipe.io/) — Privacy-focused web analytics. Free for up to 5 domains and 10K monthly pageviews.
  * [Aptabase](https://aptabase.com/) — Open-source, privacy-friendly analytics for mobile and desktop apps. Free for up to 20K events/month.
  * [Trackingplan](https://www.trackingplan.com/) — Detects analytics and marketing data issues, automates tracking plans, and enhances collaboration.
  * [LogSpot](https://logspot.io/) — Unified web and product analytics platform with embeddable widgets. Free plan includes 10K events/month.
  * [Umami](https://umami.is/) — Simple, fast, privacy-focused, open-source alternative to Google Analytics.
  * [TrackWith Dicloud](https://dicloud.net/trackwith-privacy-focused-analytics/) — Privacy-focused alternative to Google Analytics with unlimited pageviews. Free for up to 3 domains.
  * [AppFit](https://appfit.io/) — Analytics and product management tool with cross-platform support. Free plan includes 10K events/month.
  * [Seline](https://seline.so/) — Privacy-focused website and product analytics. Free for 3K events/month with access to full features.

## Data Visualization on Maps
  * [IP Geolocation](https://ipgeolocation.io/) — Free DEVELOPER plan available with 30K requests/month.
  * [Carto](https://carto.com/) — Create maps and geospatial APIs from your and public data.
  * [Clockwork Micro](https://clockworkmicro.com/) — Map tools that work like clockwork. 50,000 free monthly queries (map tiles, db2vector, elevation).
  * [ArcGIS Developers](https://developers.arcgis.com) — APIs and SDKs for maps, geospatial data storage, analysis, geocoding, routing, and more. Includes generous free tier with 2M base map tiles and 5GB free tile+data storage per month.
  ...
  * [Geoapify](https://www.geoapify.com/) — Vector and raster map tiles, geocoding, places, routing, isolines APIs. 3,000 free requests/day.
  * [Geocod.io](https://www.geocod.io/) — Geocoding via API or CSV Upload. 2,500 free queries/day.
  * [Geocodify](https://geocodify.com/) — Geocoding and Geoparsing via API or CSV Upload. 10K free queries/month.
  * [GeoJS](https://www.geojs.io/) — Highly available REST/JSON/JSONP IP Geolocation lookup API.
  * [GIS Cloud](https://www.giscloud.com/) — Visualize, analyze, and share geo data online.
  * [GraphHopper](https://www.graphhopper.com/) — Free developer package for routing, route optimization, distance matrix, geocoding, and map matching.
  * [HERE](https://developer.here.com/) — APIs and SDKs for maps and location-aware apps. 250K transactions/month for free.
  * [LocationIQ](https://locationiq.com/) — Geocoding, maps, and routing APIs. 5,000 requests/day for free.
  * [Mapbox](https://www.mapbox.com/) — Maps, geospatial services, and SDKs for displaying map data.
  * [MapTiler](https://www.maptiler.com/cloud/) — Vector maps, map services, and SDKs for map visualization. Free vector tiles with weekly updates and four map styles.
  * [Nominatim](https://nominatim.org/) — OpenStreetMap's free geocoding service with global address search and reverse geocoding.
  * [NextBillion.ai](https://nextbillion.ai/) — Geocoding, navigation, route optimization, and maps SDKs. Free tier with specific quotas for each service.
  * [OpenCage Data](https://opencagedata.com) — Geocoding API aggregating OpenStreetMap and other open geo sources. 2,500 free queries/day.
  * [OSMNames](https://osmnames.org/) — Geocoding with search results ranked by the popularity of related Wikipedia pages.
  ...
  * [Stadia Maps](https://stadiamaps.com/) — Map tiles, routing, navigation, and other geospatial APIs. 2,500 free requests/day for non-commercial use.
  * [Stamen Maps](http://maps.stamen.com/) — Free map tiles and tile hosting.
  * [IPStack](https://ipstack.com/) — Locate and identify website visitors by IP address.
  * [Geokeo](https://geokeo.com) — Geocoding API with language correction and worldwide coverage. 2,500 free daily queries.

## Translation Management
  * [Crowdin](https://crowdin.com/) — Unlimited projects, unlimited strings, and collaborators for Open Source.
  * [GitLocalize](https://gitlocalize.com) — Free and unlimited for both private and public repositories.
  ...
  * [Localazy](https://localazy.com) — Free for 1000 source language strings, unlimited languages, unlimited contributors, startup and open source deals.
  ...
  * [OneSky](https://www.oneskyapp.com/) — Limited free edition for up to 5 users, free for Open Source.
  ...
  * [Weblate](https://weblate.org/) — Free for libre projects with up to 10,000 string sources for the free tier and Unlimited Self-hosted on-premises.
  * [Free PO editor](https://pofile.net/free-po-editor) — Free for everybody.

## Mobile App Distribution and Feedback
  * [TestApp.io](https://testapp.io) — Your go-to platform for ensuring your mobile apps work as they should.
  * [Loadly](https://loadly.io) — iOS & Android beta apps distribution service offers completely free services with unlimited downloads.
  * [Diawi](https://www.diawi.com) — Deploy iOS & Android apps directly to devices.

## Game Development
  * [itch.io](https://itch.io/game-assets) — Free/Paid assets like sprites, tile sets, and character packs.
  * [Gamefresco](https://gamefresco.com/) — Discover, collect, and share free game assets from game artists everywhere.
  ...
  * [LoSpec](https://lospec.com/) — Online tools for creating pixel art and other restrictive digital art, with lots of tutorials and palette lists available.
  * [ArtStation](https://www.artstation.com/) — Marketplace for Free/Paid 2D, 3D assets, audios, icons, tile sets, and game kits. Also for showcasing art portfolios.
  * [Rive](https://rive.app/community/) — Community assets as well as tools to create your own game assets using its free plan.
  ...
  * [Poliigon](https://www.poliigon.com/) — Free and paid textures, models, HDRIs, and brushes, with plugins for Blender and more.
  * [Freesound](https://freesound.org/) — Free collaborative sound library with different CC licenses.
...
## Design and UI
  ...
  * [Ant Design Landing Page](https://landing.ant.design/) — Provides a template built by Ant Motion's motion components. Rich homepage template, downloadable code package, and editor for customization.
  * [Backlight](https://backlight.dev/) — Collaborative platform for developers and designers to build, document, and maintain Design Systems. Free plan supports up to 3 editors on one system.
  * [BoxySVG](https://boxy-svg.com/app) — A free installable web app for drawing SVGs and exporting in various formats.
  ...
  * [Cleverbrush](https://www.cleverbrush.com/) — Free Graphics Design / Photo Collage App. Offers paid integration as a component.
  * [CloudConvert](https://cloudconvert.com/) — Convert anything to anything. Supports over 200 formats, including videos and gifs.
  ...
  * [CSS Gradient](https://www.css-gradient.com/) — Free tool to quickly generate custom cross-browser CSS gradients in RGB and HEX format.
  * [EasyVectors](https://easyvectors.com/) — Free SVG vector art stock. Download the best vector graphics absolutely for free.
  * [Figma](https://www.figma.com) — Online, collaborative design tool for teams. Free tier includes unlimited files and viewers, max of 2 editors, and 3 projects.
  * [Flyon UI](https://flyonui.com/) — The easiest components library for Tailwind CSS.
  * [Framer](https://www.framer.com/) — Helps you iterate and animate interface ideas for apps, websites, or products with powerful layouts. Free plan: unlimited viewers, 2 editors, and 3 projects.
  * [FreeForCommercialUse](https://freeforcommercialuse.net/) — FFCU provides worry-free model/property release stock photos.
  ...
  * [Icons8](https://icons8.com) — Icons, illustrations, photos, music, and design tools. Free Plan offers limited formats in lower resolution. Link to Icons8 when you use their assets.
  * [Landen](https://www.landen.co) — Generate, edit, and publish beautiful websites and landing pages for your startup without code. Free tier allows one customizable website published online.
  * [Quant UX](https://quant-ux.com/) — Quant UX is a prototyping and design tool. Completely free and open source.
  * [Lensdump](https://lensdump.com/) — Free cloud image hosting.
  * [Lorem Picsum](https://picsum.photos/) — Free tool for stylish placeholders. Add desired size to URL for random images.
  * [LottieFiles](https://lottiefiles.com/) — Platform for Lottie animations, tools, and plugins for Android, iOS, and Web.
  * [MagicPattern](https://www.magicpattern.design/tools) — CSS & SVG background generators & tools for gradients, patterns, and blobs.
  * [MarvelApp](https://marvelapp.com/) — Design, prototyping, and collaboration tool. Free plan limited to one user and one project.
  * [MindMup](https://www.mindmup.com/) — Unlimited mind maps stored in the cloud, accessible from any device.
  * [Mockplus iDoc](https://www.mockplus.com/idoc) — Design collaboration & handoff tool. Free plan includes three users and five projects.
  * [MockupMark](https://mockupmark.com/create/free) — Create realistic t-shirt and clothing mockups. 40 free mockups available.
  * [Mossaik](https://mossaik.app) — Free SVG image generator with tools like waves, blobs, and patterns.
  * [MovingPencils](https://movingpencils.com) — Fast, browser-based vector editor. Completely free.
  * [Octopus.do](https://octopus.do) — Visual sitemap builder for real-time website structure creation and collaboration.
  * [Pencil](https://github.com/evolus/pencil) — Open source design tool using Electron.
  * [Penpot](https://penpot.app) — Web-based, open-source design and prototyping tool supporting SVG.
  * [Pexels](https://www.pexels.com/) — Free stock photos for commercial use. Includes a free API to search photos by keywords.
  * [Photopea](https://www.photopea.com/) — A free, advanced online design editor with Adobe Photoshop UI. Supports PSD, XCF & Sketch formats.
  * [Pixlr](https://pixlr.com/) — Free online browser editor comparable to commercial tools.
  * [Plasmic](https://www.plasmic.app/) — Web design tool and page builder that integrates into codebases. Build responsive pages or components, optionally extend with code.
  * [Pravatar](https://pravatar.cc/) — Generate random/placeholder fake avatars with direct hot-linkable URLs.
  * [Proto.io](https://www.proto.io) — Create fully interactive UI prototypes without coding. Free tier includes one user, one project, five prototypes, and 100MB storage.
  * [Resize App Icon](https://resizeappicon.com/) — A simple service to resize and manage your app icons.
  * [Rive](https://rive.app) — Create and ship animations to any platform. Free for individuals. Includes editor and hosting for graphics.
  * [Storyset](https://storyset.com/) — Create free customized illustrations for your project.
  * [Smartmockups](https://smartmockups.com/) — Create product mockups. Includes 200 free mockups.
  * [Tabler Icons](https://tabler-icons.io/) — Over 1500 free copy-and-paste SVG editable icons.
  * [UI Avatars](https://ui-avatars.com/) — Generate avatars with initials from names. URLs can be directly hot-linked with configurable parameters.
  * [unDraw](https://undraw.co/) — Constantly updated collection of beautiful SVG images. Free for use without attribution.
  * [Unsplash](https://unsplash.com/) — Free stock photos for commercial and noncommercial purposes under a do-whatever-you-want license.
  * [Vectr](https://vectr.com/) — Free design app available for Web and Desktop.
  * [WalkMe](https://www.walkme.com/) — Guidance and engagement platform. Free plan allows three walkthroughs of up to five steps each.
  * [Webflow](https://webflow.com) — WYSIWYG website builder with animations and hosting. Free for two projects.
  * [Updrafts](https://updrafts.app) — WYSIWYG website builder for Tailwind CSS-based designs. Free for non-commercial use.
  * [Whimsical](https://whimsical.com/) — Collaborative flowcharts, wireframes, sticky notes, and mind maps. Create up to 4 free boards.
  ...
  * [xLayers](https://xlayers.dev) — Preview and convert Sketch design files into Angular, React, Vue, LitElement, Stencil, Xamarin, and more. Free and open source.
  * [Grapedrop](https://grapedrop.com/) — Responsive, powerful, SEO-optimized web page builder based on GrapesJS Framework. Free for the first five pages.
  ...
  * [React Favicon](https://react-favicon.com/) — Generate Favicons for your website using React and JSX with any font and icon library.
  * [SVGmix](https://www.svgmix.com/) — Massive repository of 300K+ free SVG icons, collections, and brand logos. Includes a simple browser-based vector editing tool.
  * [SVGRepo](https://www.svgrepo.com/) — Explore and find free SVG vectors and icons for your projects using various vector libraries.
  * [Haikei](https://www.haikei.app/) — Generate unique SVG shapes, backgrounds, and patterns for design tools and workflows.
  * [Canva](https://canva.com) — Free online design tool to create visual content.
  * [Superdesigner](https://superdesigner.co) — A collection of free design tools to create unique backgrounds, patterns, shapes, and more.
  * [TeleportHQ](https://teleporthq.io/) — Low-code Front-end Design & Development Platform. Free for three projects, unlimited collaborators, and free code export.
  * [Vector Express](https://vector.express) — Convert your AI, CDR, DWG, DXF, EPS, HPGL, PDF, PLT, PS, and SVG vector files fast and easily.
  * [Vertopal](https://www.vertopal.com) — Free online platform for converting files to various formats, including developer formats like JPG to SVG, GIF to APNG, and JSON to XML.
  * [Okso](https://okso.app) — Minimalistic online drawing app. Allows creating fast sketches and visual notes. Exports to PNG, JPG, SVG, and WEBP.
  ...
  * [Logo.dev](https://www.logo.dev) — Company logo API with 44M+ brands. First 10,000 API calls are free.
  * [MDBootstrap](https://mdbootstrap.com/) — Free Bootstrap, Angular, React, and Vue UI Kits for personal and commercial use, with over 700 components.
  * [TW Elements](https://tw-elements.com/) — Free Bootstrap components recreated with Tailwind CSS, offering better design and functionalities.
  ...
  * [Hypercolor](https://hypercolor.dev/) — Curated collection of Tailwind CSS color gradients and tools for creating your own.
  * [Iconify](https://icon-sets.iconify.design/) — Collection of over 100 icon packs with a unified interface. Export icons as SVGs or for popular frameworks.
  * [NextUI](https://nextui.org/) — Free, beautiful, fast, and modern React & Next.js UI library.
  * [Glyphs](https://glyphs.fyi/) — Free, fully editable, open-source design system with icons.
  * [ShadcnUI](https://ui.shadcn.com/) — Beautifully designed components for apps. Accessible, customizable, and open source.
  ...
  * [Image BG Blurer](https://imagebgblurer.com/) — Generate a blurred background frame for an image using that image source as the blur, ideal for Notion, Trello, Jira, etc.
  * [Webstudio](https://webstudio.is/) — Open-source alternative to Webflow. Free plan includes unlimited websites on their domain and 5 websites with custom domains.
  * [Nappy](https://nappy.co/) — Beautiful photos of Black and Brown people, for free. For commercial and personal use.

## Design Inspiration
  * [Awwwards](https://www.awwwards.com/) — Showcase of the best-designed websites as voted on by designers.
  * [Behance](https://www.behance.net/) — Platform where designers showcase their work. Filterable with categories for UI/UX projects.
  * [Dribbble](https://dribbble.com/) — Unique design inspiration, generally not from real applications.
  * [Landings](https://landings.dev/) — Find the best landing pages for your design inspiration based on your preferences.
  * [Lapa Ninja](https://www.lapa.ninja/) — Gallery featuring the best landing page examples, free books for designers, and free UI kits from around the web.
  * [LovelyLanding](https://www.lovelylanding.net/) — Frequently updated landing page screenshots. Includes Desktop, Tablet, and Mobile versions.
  * [Mobbin](https://mobbin.design/) — Library of 50,000+ fully searchable mobile app screenshots to save hours of UI & UX research.
  * [Uiland Design](https://uiland.design/) — Explore Mobile and Web UI Designs from leading companies in Africa and the world.
  * [Mobile Patterns](https://www.mobile-patterns.com/) — Inspirational library featuring the finest UI/UX patterns (iOS and Android) for designers, developers, and product makers.
  * [Page Flows](https://pageflows.com/) — Videos of full flows across many mobile and web apps, including screenshots. Highly searchable and indexed.
  * [Screenlane](https://screenlane.com/) — Get inspired and keep up with the latest web & mobile app UI design trends. Filterable by pattern and app.
  * [Scrnshts](https://scrnshts.club/) — Hand-picked collection of the finest app store design screenshots.
  * [UI Garage](https://uigarage.net/) — Daily UI inspiration & patterns for designers and developers to find tools and resources for projects.
  * [Refero](https://refero.design/) — Tagged and searchable collection of design references from great web applications.

## Font
  * [dafont](https://www.dafont.com/) — The fonts on this site are the property of their authors and may be freeware, shareware, demo versions, or public domain.
  * [Everything Fonts](https://everythingfonts.com/) — Offers multiple tools, including @font-face, Units Converter, Font Hinter, and Font Submitter.
  * [Font Squirrel](https://www.fontsquirrel.com/) — Freeware fonts licensed for commercial work, hand-selected and presented in an easy-to-use format.
  * [Google Fonts](https://fonts.google.com/) — A wide selection of free fonts, easy to install via download or link to Google's CDN.
  * [FontGet](https://www.fontget.com/) — A variety of fonts available for download, organized with tags for easy sorting.
  * [Fontshare](https://www.fontshare.com/) — Free font service with a growing collection of professional-grade fonts, 100% free for personal and commercial use.
  * [Befonts](https://befonts.com/) — Offers several unique fonts for personal or commercial use.
  * [Font of Web](https://fontofweb.com/) — Allows identification of all fonts used on a website and how they are implemented.
  * [Bunny](https://fonts.bunny.net) — Privacy-oriented alternative to Google Fonts.
  * [FontsKey](https://www.fontskey.com/) — Provides free and commercial paid fonts for personal use, with quick filtering options.
  * [fonts.xz.style](https://fonts.xz.style/) — Free and open-source service for delivering font families to websites using CSS.
  * [Fontsensei](https://fontsensei.com/) — Open-source Google fonts with user-added tags, including CJK (Chinese, Japanese, Korean) font tags.

## Forms
  * [Feathery](https://feathery.io) — Developer-friendly form builder for creating complex applications, up to 250 submissions/month and 5 active forms on the free plan.
  * [Form-Data](https://form-data.com) — No-code form backend with spam filter, email notifications, webhooks, and more. Free plan offers unlimited forms with 20 submissions/month.
  * [FabForm](https://fabform.io/) — Form backend with integrations for Google Sheets, Airtable, Slack, and more. Free plan allows 250 submissions per month.
  * [Form.taxi](https://form.taxi/) — Endpoint for HTML form submissions with spam blockers and GDPR-compliant processing. Basic usage is free.
  * [Formcarry](https://formcarry.com) — Form endpoint service allowing 100 monthly submissions on the free plan.
  * [formingo.co](https://www.formingo.co/) — Simple HTML form backend for static websites with 500 monthly submissions on the free plan.
  * [FormKeep](https://www.formkeep.com/) — Unlimited forms with spam protection and email notifications; 50 submissions per month on the free plan.
  * [formlets](https://formlets.com/) — Online form service with unlimited single-page forms and 100 submissions per month for free.
  * [formspark](https://formspark.io/) — Email form service with unlimited forms and 250 submissions per month on the free plan.
  * [Formspree](https://formspree.io/) — Email submission for HTML forms, with a 50 submissions/month limit for free users.
  * [Formsubmit.co](https://formsubmit.co/) — Simple HTML form endpoint with no registration required, free to use indefinitely.
  * [Formlick](https://formlick.com) — Typeform alternative with unlimited submissions on free plan; 1 form allowed.
  * [getform](https://getform.io/) — Form backend with single-file upload, free plan includes 1 form and 50 submissions.
  * [HeroTofu](https://herotofu.com/) — Forms backend with encryption and spam detection; free plan allows 100 submissions per month.
  * [HeyForm](https://heyform.net/) — Drag-and-drop form builder with unlimited forms and submissions for free users.
  * [Tally.so](https://tally.so/) — Full-featured form service with unlimited forms and submissions, form logic, payment integration, and file uploads.
  * [Hyperforms](https://hyperforms.app/) — Form backend with 50 free submissions per month and no need for backend code.
  * [Kwes](https://kwes.io/) — Form endpoint service suitable for static sites, allowing 50 submissions per month for free.
  * [Pageclip](https://pageclip.co/) — One form with up to 1,000 submissions per month on the free plan.
  * [Qualtrics Survey](https://qualtrics.com/free-account) — Professional survey tool with templates, free for 100 responses per survey.
  * [Screeb](https://screeb.app/) — In-app surveys with unlimited responses and events for up to 500 users on the free plan.
  * [smartforms](https://smartforms.dev/) — Form backend with 50 submissions per month, file storage, and integrations with Zapier and Slack on the free plan.
  * [Survicate](https://survicate.com/) — Survey and feedback tool with free email and in-app surveys, 25 monthly responses.
  * [staticforms](https://www.staticforms.xyz/) — HTML form endpoint service with email notifications.
  * [stepFORM](https://stepform.io) — Quiz and form builder with up to 3 steps per form and 50 responses per month on the free plan.
  * [Typeform](https://www.typeform.com/) — Beautiful online forms with up to 100 responses per month on the free plan.
  * [WaiverStevie](https://waiverstevie.com) — Electronic signature platform with webhook notifications; free plan with watermarked documents.
  * [Web3Forms](https://web3forms.com) — Form service for JAMStack websites with unlimited forms and domains, and 250 submissions per month.
  * [WebAsk](https://webask.io) — Survey and form builder with 3 surveys and 100 monthly responses on the free plan.
  * [Wufoo](https://www.wufoo.com/) — Easy form builder with 100 monthly submissions on the free plan.
  * [formpost](https://formpost.app) — Free form-to-email service with custom redirect, auto-response, and webhooks.
  * [Formester](https://formester.com) — Form builder with unlimited forms and 100 submissions per month on the free plan.
  * [SimplePDF](https://simplepdf.eu/embed) — Embed a PDF editor on your website; unlimited PDFs with 3 submissions per PDF on the free plan.
  * [forms.app](https://forms.app/) — Powerful online form creator with conditional logic and scoring, free for up to 100 responses.
  * [Qualli](https://usequalli.com) — In-app survey tool with AI-assisted question suggestions, free for 500 monthly active users.
  * [Sprig](https://sprig.com/) — GPT-powered survey analysis with one free in-product survey or replay per month.
  * [feedback.fish](https://feedback.fish/) — Feedback collection tool with 25 submissions allowed on the free plan, integrates with React and Vue.

## Privacy Management
  * [Bearer](https://www.bearer.sh/) — Helps implement privacy by design via audits and workflows for GDPR and regulation compliance. Free tier for smaller teams and SaaS version only.
  * [Osano](https://www.osano.com/) — Consent management and compliance platform, including GDPR representation and cookie banners. Free tier offers basic features.
  * [Iubenda](https://www.iubenda.com/) — Privacy and cookie policies and consent management. Free tier provides limited policies and banners.
  * [CookieFirst](https://cookiefirst.com/) — Cookie banners, auditing, and consent management. Free tier includes a one-time scan and a single banner.
  * [Ketch](https://www.ketch.com/) — Consent management and privacy framework tool. Free tier includes most features with a limited visitor count.
  * [Concord](https://www.concord.tech/) — Full data privacy platform including consent management, DSARs handling, and data mapping. Free tier provides core consent management features. Advanced plan available for verified open source projects.

## Security and PKI
  * [Aikido](https://www.aikido.dev) — All-in-one application security platform including SCA, SAST, DAST, IaC scanning, and more. Free plan includes scanning for up to 10 repositories, 1 cloud, 2 containers, and 1 domain.
  * [AlienVault Open Threat Exchange](https://www.alienvault.com/open-threat-exchange/reputation-monitor) — Helps uncover compromised systems in your network.
  * [Altcha Anti-Spam](https://altcha.org/anti-spam) — Spam filter for websites and APIs using NLP and machine learning. Free plan includes 200 requests per day per domain.
  * [Atomist](https://atomist.com/) — Automates various development tasks to save time and increase efficiency. Currently in beta.
  * [Bridgecrew](https://bridgecrew.io/) — IaC security platform powered by the open-source tool Checkov. Free for up to 50 infrastructure resources.
  * [CloudSploit](https://cloudsploit.com/) — AWS security and compliance auditing and monitoring service.
  * [CyberChef](https://gchq.github.io/CyberChef/) — Web app for analyzing and encoding/decoding data with various cryptography tools. Fully free and open-source.
  * [Dependabot](https://dependabot.com/) — Automated dependency updates for a wide range of languages and frameworks. Free for public repositories.
  * [Doppler](https://doppler.com/) — Universal secrets manager for application secrets and configurations. Free for up to 5 users with basic access controls.
  * [Let’s Encrypt](https://letsencrypt.org/) — Free SSL certificate authority trusted by all major browsers.
  * [Mozilla Observatory](https://observatory.mozilla.org/) — Tool to find and fix security vulnerabilities on your website.
  * [Sucuri SiteCheck](https://sitecheck.sucuri.net) — Free website security check and malware scanner.
  * [Tinfoil Security](https://www.tinfoilsecurity.com/) — Automated vulnerability scanning. Free plan includes weekly XSS scans.
  * [StackHawk](https://www.stackhawk.com/) — Application scanning tool to find and fix security bugs before production. Free for a single app with unlimited scans.
  * [SSLLabs](https://www.ssllabs.com/ssltest/) — Comprehensive analysis of SSL web server configurations.
  * [Snyk](https://snyk.io) — Tool for finding and fixing security vulnerabilities in open-source dependencies. Unlimited tests for open-source projects, with a limit of 200 tests/month for private projects.
  * [GitGuardian](https://www.gitguardian.com) — Automated secrets detection and remediation tool for source code. Free for individuals and teams of up to 25 developers.
  * [Internet.nl](https://internet.nl) — Tool to test compliance with modern Internet standards like IPv6, DNSSEC, HTTPS, and more.
  * [Escape GraphQL Quickscan](https://escape.tech/) — One-click security scan for GraphQL endpoints. No login required and completely free.
  * [HasMySecretLeaked](https://gitguardian.com/hasmysecretleaked) — Search for exposed secrets in public GitHub repositories, gists, issues, and comments for free.
  * [Qualys Community Edition](https://www.qualys.com/community-edition) — Find vulnerabilities in web apps and audit for OWASP risks. Free community edition available.
  * [Protectumus](https://protectumus.com) — Free website security check, site antivirus, and server firewall (WAF) for PHP-based sites. Includes email notifications for registered users in the free tier.
  * [TestTLS.com](https://testtls.com) — Free tool for testing SSL/TLS server configuration, certificates, and chains. Supports HTTPS and other protocols.
  * [Dotenv](https://dotenv.org/) — Securely sync your .env files across teams. Free for up to 3 teammates.
  * [Pixee AI](https://pixee.ai) — Automated security engineering GitHub bot that resolves vulnerabilities in Java codebases with PRs. Free for now, with more languages coming soon.
  * [Vulert](https://vulert.com) — Monitors your open-source dependencies for vulnerabilities and recommends fixes without requiring codebase access. Free for open-source projects.
  * [Public Cloud Threat Intelligence](https://cloudintel.himanshuanand.com/) — High-confidence indicators of compromise targeting public cloud infrastructure. Partial data available on GitHub, full data via API.
  * [RingCaptcha](https://ringcaptcha.com/) — Tools for using phone numbers as identification. Free plan available.
  * [OpenAPI Security](https://openapi.security/) — Free tool for checking the security of OpenAPI/Swagger-based APIs. No signup required.

## DNS
  * [1.1.1.1](https://developers.cloudflare.com/1.1.1.1/) — Free public DNS Resolver by Cloudflare. Encrypts DNS queries, prevents spying, blocks adult & malware content, and can be used via API. Note: Just a DNS resolver, not a DNS hoster.
  * [1984.is](https://www.1984.is/product/freedns/) — Free DNS service with API and many other DNS features included.
  * [CloudNS](https://www.cloudns.net/) — Free DNS hosting for up to 1 domain with 50 records.
  * [deSEC](https://desec.io) — Free DNS hosting with API support, focused on security. Open-source software supported by SSE.
  * [dns.he.net](https://dns.he.net/) — Free DNS hosting service with Dynamic DNS support.
  * [Zonomi](https://zonomi.com/) — Free DNS hosting service with instant DNS propagation. Free plan includes 1 DNS zone with up to 10 records.
  * [DNSPod](https://www.dnspod.com/) — Free DNS hosting.
  * [DuckDNS](https://www.duckdns.org/) — Free DDNS with up to 5 domains. Includes configuration guides for various setups.
  * [Dynv6](https://dynv6.com/) — Free DDNS service with API support and management of various DNS record types.
  * [FreeDNS by Afraid.org](https://freedns.afraid.org/) — Free DNS hosting and subdomains from user-contributed domains.
  * [LuaDNS](https://www.luadns.com/) — Free DNS hosting for three domains with reasonable limits.
  * [Namecheap](https://www.namecheap.com/domains/freedns/) — Free DNS hosting with no limit on the number of domains.
  * [NextDNS](https://nextdns.io) — DNS-based firewall, free for 300K queries monthly.
  * [NoIP.at](https://noip.at/) — Free DDNS service without registration or tracking, with no domain limit.
  * [NoIP](https://www.noip.com/) — Dynamic DNS service allowing up to 3 hostnames for free with 30-day confirmation.
  * [SSLIP.io](https://sslip.io/) — Free DNS service that returns an IP address embedded in a queried hostname.
  * [Zilore](https://zilore.com/en/dns) — Free DNS hosting for up to 5 domains.
  * [ZoneEdit](https://www.zoneedit.com/free-dns/) — Free DNS hosting with Dynamic DNS support.
  * [ZoneWatcher](https://zonewatcher.com) — Automatic backups and DNS change monitoring for one domain free.
  * [Huawei Cloud DNS](https://www.huaweicloud.com/intl/en-us/product/dns.html) — Free DNS hosting by Huawei.
  * [Hetzner DNS](https://www.hetzner.com/dns-console) — Free DNS hosting from Hetzner with API support.
  * [Glauca](https://docs.glauca.digital/hexdns/) — Free DNS hosting for up to 3 domains with DNSSEC support.
...
## Education and Career Development
  ...
  * [MIT OpenCourseWare](https://ocw.mit.edu/) — MIT OpenCourseWare is an online publication of materials from over 2,500 MIT courses, freely sharing knowledge with learners and educators around the world. Youtube channel can be found at @mitocw.

## Search
  * [Algolia](https://www.algolia.com/) — Hosted search solution with typo-tolerance, relevance, and UI libraries to easily create search experiences. The free 'Build' plan includes 1M documents and 10K searches/month.
...
## Email
  ...
  * [EmailJS](https://www.emailjs.com/) — Email client for sending emails directly from the client without exposing credentials. Free tier with 200 monthly requests.
  * [EtherealMail](https://ethereal.email) — Fake SMTP service mainly for Nodemailer and EmailEngine users. Messages never get delivered.
  * [Temp-Mail.org](https://temp-mail.org/en/) — Temporary / Disposable Mail Generator with multiple domain options. Refreshes on reload.
  * [TempMailDetector.com](https://tempmaildetector.com/) — Verify up to 200 emails a month for free to check if an email is temporary.
  * [Emailvalidation.io](https://emailvalidation.io) — 100 free email verifications per month.
  * [FakeMailGenerator.com](https://www.fakemailgenerator.com/) — German temporary/disposable mail generator with 10 domains and unlimited addresses.
  * [forwardemail.net](https://forwardemail.net) — Free email forwarding for custom domains with unlimited email addresses.
  * [Imitate Email](https://imitate.email) — Sandbox Email Server for testing email functionality. Free accounts get 15 emails a day forever.
  * [ImprovMX](https://improvmx.com) — Free email forwarding.
  * [EForw](https://www.eforw.com) — Free email forwarding for one domain. Receive and send emails from your domain.
  * [Inboxes App](https://inboxesapp.com) — Create up to 3 temporary emails a day for testing signup flows.
  * [inboxkitten.com](https://inboxkitten.com/) — Free temporary/disposable email inbox, auto-deletes in 3 days, open-source.
  * [mail-tester.com](https://www.mail-tester.com) — Test if email DNS/SPF/DKIM/DMARC settings are correct, 20 free tests per month.
  * [dkimvalidator.com](https://dkimvalidator.com/) — Free service to test if email DNS/SPF/DKIM/DMARC settings are correct.
  * [mailcatcher.me](https://mailcatcher.me/) — Catches mail and serves it through a web interface.
  * [Mailcheck.ai](https://www.mailcheck.ai/) — Prevents users from signing up with temporary email addresses, 120 requests/hour.
  ...
  * [mailinator.com](https://www.mailinator.com/) — Free, public email system with any inbox you want.
  * [Mailjet](https://www.mailjet.com/) — 6,000 emails/month free (200 emails daily limit).
  * [Mailnesia](https://mailnesia.com) — Free temporary/disposable email, auto-visits registration links.
  * [mailsac.com](https://mailsac.com) — API for temporary email testing, free public email hosting, and more.
  * [Mailtrap.io](https://mailtrap.io/) — Fake SMTP server for development, free plan with one inbox, 100 messages, and more.
  * [Mail7.io](https://www.mail7.io/) — Free Temp Email Addresses for QA Developers with Web Interface or API.
  * [Momentary Email](https://www.momentaryemail.com/) — Free Temporary Email Addresses with RSS feed reading.
  * [Mutant Mail](https://www.mutantmail.com/) — Free 10 Email IDs, 1 Domain, 1 Mailbox.
  ...
  * [Plunk](https://useplunk.com) — 3,000 emails/month for free.
  * [Postmark](https://postmarkapp.com/) — 100 emails/month free, unlimited DMARC weekly digests.
  * [Proton Mail](https://proton.me/mail) — Free secure email service with end-to-end encryption, 1GB storage.
  * [Queuemail.dev](https://queuemail.dev) — Reliable email delivery API with 10,000 free emails/month.
  * [QuickEmailVerification](https://quickemailverification.com) — Verify 100 emails daily for free.
  * [Resend](https://resend.com) — Transactional emails API, 3,000 emails/month, 100 emails/day free.
  ...
  * [SimpleLogin](https://simplelogin.io/) — Open-source, self-hostable email alias/forwarding solution. Free 5 Aliases, unlimited bandwidth.
  * [Substack](https://substack.com) — Unlimited free newsletter service, pay when you charge.
  * [Sweego](https://www.sweego.io/) — 500 emails/day free.
  * [Takeout](https://takeout.bysourfruit.com) — 500 transactional emails/month free.
  * [temp-mail.io](https://temp-mail.io) — Free disposable temporary email service.
  * [tinyletter.com](https://tinyletter.com/) — 5,000 subscribers/month free.
  * [Touchlead](https://touchlead.app) — Free for limited leads and automations.
  * [trashmail.com](https://www.trashmail.com) — Free disposable email with forwarding and auto-expiration.
  * [Tutanota](https://tutanota.com/) — Free secure email with end-to-end encryption, 1GB storage, partially open-source.
  * [Verifalia](https://verifalia.com/email-verification-api) — Real-time email verification API, 25 free verifications/day.
  * [verimail.io](https://verimail.io/) — Bulk and API email verification service. 100 free verifications/month.
  * [Zoho](https://www.zoho.com) — Free suite of services including email, project management, and CRM.
  * [Maileroo](https://maileroo.com) — SMTP relay and email API for developers, 5,000 emails/month, free email verification.
...
## Storage and Media Processing
  ...
  * [BorgBase](https://www.borgbase.com/) — Simple and secure offsite backup hosting for Borg Backup. 10 GB free backup space and two repositories.
  * [Icedrive](https://www.icedrive.net/) — Simple cloud storage service. 10 GB free storage.
  * [Sync.com](https://www.sync.com/) — End-to-End cloud storage service. 5 GB of free storage.
  * [pCloud](https://www.pcloud.com/) — Cloud storage service. Up to 10 GB of free storage.
  * [Sirv](https://sirv.com/) — Smart Image CDN with on-the-fly image optimization and resizing. The free tier includes 500 MB of storage and 2 GB of bandwidth.
  * [Cloudimage](https://www.cloudimage.io/en/home) — Full image optimization and CDN service with 1500+ Points of Presence around the world. A variety of image resizing, compression, and watermarking functions. Open source plugins for responsive images, 360 image making and image editing. Free monthly plan with 25GB of CDN traffic 25GB of cache storage and unlimited transformations.
  * [Cloudinary](https://cloudinary.com/) — Image upload, powerful manipulations, storage, and delivery for sites and apps, with Ruby, Python, Java, PHP, Objective-C, and more libraries. The free tier includes 25 monthly credits. One credit equals 1,000 image transformations, 1 GB of storage, or 1 GB of CDN usage.
  ...
  * [Filestack](https://www.filestack.com/) — File picker, transform, and deliver, free for 250 files, 500 transformations, and 3 GB bandwidth.
  ...
  * [Freetools](https://freetools.site/) — Free online tools. Convert or edit documents, images, audio, video, and more.
  ...
  * [Gumlet](https://www.gumlet.com/) — Image and video hosting, processing and streaming via CDN. Provides generous free tier of 250 GB/month for videos and 30 GB/month for images.
  * [Image-Charts](https://www.image-charts.com/) — Unlimited image chart generation with a watermark.
  ...
  * [NitroPack](https://nitropack.io/) — Accelerate your site's speed on autopilot with complete front-end optimization (caching, images and code optimization, CDN). Free for up to 5,000 pageviews/month.
  * [Otixo](https://www.otixo.com/) — Encrypt, share, copy, and move all your cloud storage files from one place. The basic plan provides unlimited file transfer with 250 MB max. file size and allows five encrypted files.
  * [PackageCloud](https://packagecloud.io/) — Hosted Package Repositories for YUM, APT, RubyGem and PyPI. Limited free plans and open-source plans are available via request.
  * [GetPantry](https://getpantry.cloud/) — A simple JSON data storage API perfect for personal projects, hackathons, and mobile apps!
  * [Piio](https://piio.co/) — Responsive image optimization and delivery for every website. Free plan for developers and personal websites. Includes free CDN, WebP, and Lazy Loading out of the box.
  ...
  * [PlaceKitten](https://placekitten.com/) — A quick and simple service for getting pictures of kittens for use as placeholders.
  * [Plotly](https://plot.ly/) — Graph and share your data. The free tier includes unlimited public files and ten private files.
  * [QuickChart](https://quickchart.io) — Generate embeddable image charts, graphs, and QR codes.
  * [Redbooth](https://redbooth.com) — P2P file syncing, free for up to 2 users.
  ...
  * [TinyPNG](https://tinypng.com/) — API to compress and resize PNG and JPEG images, offers 500 compressions for free each month.
  * [Transloadit](https://transloadit.com/) — Handles file uploads and encoding of video, audio, images, documents. Free for Open source, charities, and students via the GitHub Student Developer Pack. Commercial applications get 2 GB free for test driving.
  * [TwicPics](https://www.twicpics.com) — Responsive images as a service. It provides an image CDN, a media processing API, and a frontend library to automate image optimization. The service is free for up to 3GB of traffic/per month.
  ...
  * [Internxt](https://internxt.com) — Internxt Drive is a zero-knowledge file storage service based on absolute privacy and uncompromising security. Sign up and get 10 GB for free, forever!
  * [Degoo](https://degoo.com/) — AI based cloud storage with free up to 20 GB, three devices, 5 GB referral bonus (90 days account inactivity).
  * [MConverter](https://mconverter.eu/) — Convert files in bulk. Supports many file formats, including new ones like AVIF. Extract all image frames from videos. Free for up to ten 100MB-files per day, processed in batches of two.
  * [ImageEngine](https://imageengine.io/) — ImageEngine is an easy to use global image CDN. Sub 60 sec setup. AVIF and JPEGXL support, WordPress-, Magento-, React-, Vue- plugins and more. Claim your free developer account.
...
## Commenting Platforms
  ...
  * [Remarkbox](https://www.remarkbox.com/) — Open source hosted comments platform, pay what you can for one moderator on a few domains with complete control over behavior and appearance.
...
## Remote Desktop Tools
  * [Getscreen.me](https://getscreen.me) — Free for 2 devices, with no limits on the number and duration of sessions.
  * [Apache Guacamole™](https://guacamole.apache.org/) — Open-source clientless remote desktop gateway.
  * [RemSupp](https://remsupp.com) — On-demand support and permanent access to devices. Free for 2 sessions/day.
